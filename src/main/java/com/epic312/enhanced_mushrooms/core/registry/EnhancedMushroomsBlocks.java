...
public class EnhancedMushroomsBlocks {
    ...
    public static final RegistryObject<Block> GLOWSHROOM_HYPHAE = HELPER.createCompatBlock("quark","glowshroom_hyphae", ()->new AlphaWoodBlock(STRIPPED_GLOWSHROOM_HYPHAE, Block.Properties.from(Blocks.OAK_WOOD).notSolid().lightValue(14)), ItemGroup.BUILDING_BLOCKS);
    public static final RegistryObject<Block> GLOWSHROOM_PLANKS = HELPER.createCompatBlock("quark","glowshroom_planks", ()->new AlphaPlanksBlock(Block.Properties.from(Blocks.OAK_PLANKS).notSolid().lightValue(14)), ItemGroup.BUILDING_BLOCKS);
    public static final RegistryObject<Block> GLOWSHROOM_SLAB = HELPER.createCompatBlock("quark","glowshroom_slab", ()->new AlphaWoodSlabBlock(Block.Properties.from(Blocks.OAK_SLAB).notSolid().lightValue(14)), ItemGroup.BUILDING_BLOCKS);
    public static final RegistryObject<Block> GLOWSHROOM_STAIRS = HELPER.createCompatBlock("quark","glowshroom_stairs", ()->new AlphaWoodStairsBlock(BROWN_MUSHROOM_PLANKS.get().getDefaultState(), Block.Properties.from(Blocks.OAK_STAIRS).notSolid().lightValue(14)), ItemGroup.BUILDING_BLOCKS);
    ...
    public static final RegistryObject<Block> GLOWSHROOM_FENCE = HELPER.createCompatBlock("quark","glowshroom_fence", ()->new AlphaWoodFenceBlock(Block.Properties.from(Blocks.OAK_FENCE).notSolid().lightValue(14)), ItemGroup.DECORATIONS);
    public static final RegistryObject<Block> GLOWSHROOM_FENCE_GATE = HELPER.createCompatBlock("quark","glowshroom_fence_gate", ()->new AlphaWoodFenceGateBlock(Block.Properties.from(Blocks.OAK_FENCE_GATE).notSolid().lightValue(14)), ItemGroup.REDSTONE);
    ...
    public static final Pair<RegistryObject<AbnormalsStandingSignBlock>, RegistryObject<AbnormalsWallSignBlock>> GLOWSHROOM_SIGNS = HELPER.createCompatSignBlock("quark","glowshroom", MaterialColor.BLUE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lightValue(14));

    public static final RegistryObject<Block> VERTICAL_GLOWSHROOM_PLANKS = HELPER.createCompatBlock("quark","vertical_glowshroom_planks", ()->new AlphaBlock(Block.Properties.from(Blocks.OAK_PLANKS).notSolid().lightValue(14)), ItemGroup.BUILDING_BLOCKS);
    public static final RegistryObject<Block> GLOWSHROOM_VERTICAL_SLAB = HELPER.createCompatBlock("quark","glowshroom_vertical_slab", ()->new AlphaVerticalSlabBlock(Block.Properties.from(Blocks.OAK_PLANKS).notSolid().lightValue(14)), ItemGroup.BUILDING_BLOCKS);
