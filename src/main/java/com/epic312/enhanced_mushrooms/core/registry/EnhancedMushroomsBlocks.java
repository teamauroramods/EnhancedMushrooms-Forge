...
public class EnhancedMushroomsBlocks {
    ...
    public static final RegistryObject<Block> GLOWSHROOM_BEEHIVE = HELPER.createTwoCompatBlock("buzzierbees","quark","glowshroom_beehive", ()->new AlphaAbnormalsBeehiveBlock(addLight(Block.Properties.from(Blocks.BEEHIVE).notSolid(),14)), ItemGroup.DECORATIONS);
