package com.epic312.enhanced_mushrooms.common.world.biome.features;
...
public abstract class AbstractBigGlowshroomFeature extends Feature<BigMushroomFeatureConfig> {
    public AbstractBigGlowshroomFeature(Function<Dynamic<?>, ? extends BigMushroomFeatureConfig> p_i225795_1_) {
        super(p_i225795_1_);
    }
