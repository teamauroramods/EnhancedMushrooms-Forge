...
public class EMItems {
    ...
    public static final RegistryObject<Item> ROASTED_MUSHROOMS = HELPER.createItem("roasted_mushrooms", ()->new Item(new Item.Properties().food(EMFoods.ROASTED_MUSHROOMS).group(ItemGroup.FOOD)));
    public static final RegistryObject<Item> BEEF_STEW = HELPER.createItem("beef_stew", ()->new SoupItem(new Item.Properties().maxStackSize(1).food(EMFoods.BEEF_STEW).group(ItemGroup.FOOD)));
}
